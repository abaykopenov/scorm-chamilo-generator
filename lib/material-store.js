...
import { deleteMaterialFromQdrant } from "./langchain-qdrant.js";
...
export async function deleteMaterial(materialId) {
  ...
  const qdrant = await deleteMaterialFromQdrant(materialId).catch((error) => ({
    ok: false,
    skipped: false,
    materialId,
    message: error instanceof Error ? error.message : "Qdrant delete failed."
  }));
