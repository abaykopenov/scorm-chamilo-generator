...
/**
 * Detect Kazakh text by looking for Kazakh-specific Cyrillic characters.
 * Kazakh uses: ә, ғ, қ, ң, ө, ұ, ү, і, һ (and their uppercase forms)
 */
export function isKkText(value) {
  return /[\u04D9\u04D8\u0493\u0492\u049B\u049A\u04A3\u04A2\u04E9\u04E8\u04B1\u04B0\u04AF\u04AE\u0456\u0406\u04BB\u04BA]/.test(`${value || ""}`);
}
