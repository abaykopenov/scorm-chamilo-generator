...
function buildScreenNarrative({ text, bullets, title, audience, phase, courseTitle }) {
  ...
  const contextLine = ru
    ? `\u042d\u0442\u043e\u0442 \u044d\u043a\u0440\u0430\u043d \u043f\u043e\u0441\u0432\u044f\u0449\u0435\u043d \u0442\u0435\u043c\u0435 "${titleForNarrative}" \u0438 \u043f\u043e\u043a\u0430\u0437\u044b\u0432\u0430\u0435\u0442, \u043a\u0430\u043a \u0435\u0435 \u043f\u0440\u0438\u043c\u0435\u043d\u044f\u0442\u044c \u043d\u0430 \u043f\u0440\u0430\u043a\u0442\u0438\u043a\u0435 \u0434\u043b\u044f \u0430\u0443\u0434\u0438\u0442\u043e\u0440\u0438\u0438 "${safeAudience}".`
    : `This screen covers "${titleForNarrative}" and shows how ${safeAudience} can apply it in practice.`;
  ...
  const detailLine = ru
    ? `\u0412 \u0445\u043e\u0434\u0435 \u0438\u0437\u0443\u0447\u0435\u043d\u0438\u044f \u0437\u0430\u0444\u0438\u043a\u0441\u0438\u0440\u0443\u0439\u0442\u0435 \u0442\u0440\u0438 \u0442\u0435\u0437\u0438\u0441\u0430: 1) ${detailItems[0]}; 2) ${detailItems[1]}; 3) ${detailItems[2]}.`
    : `Capture three key points: 1) ${detailItems[0]}; 2) ${detailItems[1]}; 3) ${detailItems[2]}.`;
...
function pickDistinctDistractors(pool, correct, index, ru) {
  ...
  while (picked.length < 3) {
    picked.push(
      ru
        ? `\u0423\u0442\u0432\u0435\u0440\u0436\u0434\u0435\u043d\u0438\u0435 \u043d\u0435 \u043f\u043e\u0434\u0442\u0432\u0435\u0440\u0436\u0434\u0430\u0435\u0442\u0441\u044f \u0442\u0435\u043c\u043e\u0439 "${correct.topic}".`
        : `This statement is not supported by "${correct.topic}".`
    );
  }
...
function buildKnowledgeQuestion(index, question, context) {
  ...
  const promptTemplates = ru
    ? [
        `\u0412\u044b\u0431\u0435\u0440\u0438\u0442\u0435 \u0443\u0442\u0432\u0435\u0440\u0436\u0434\u0435\u043d\u0438\u0435, \u043a\u043e\u0442\u043e\u0440\u043e\u0435 \u0442\u043e\u0447\u043d\u043e \u0441\u043e\u043e\u0442\u0432\u0435\u0442\u0441\u0442\u0432\u0443\u0435\u0442 \u0442\u0435\u043c\u0435 "${correct.topic}".`,
        `\u041a\u0430\u043a\u043e\u0439 \u0432\u0430\u0440\u0438\u0430\u043d\u0442 \u043f\u043e\u0434\u0442\u0432\u0435\u0440\u0436\u0434\u0430\u0435\u0442\u0441\u044f \u0441\u043e\u0434\u0435\u0440\u0436\u0430\u043d\u0438\u0435\u043c \u0442\u0435\u043c\u044b "${correct.topic}"?`,
        `\u0427\u0442\u043e \u044f\u0432\u043b\u044f\u0435\u0442\u0441\u044f \u043a\u043e\u0440\u0440\u0435\u043a\u0442\u043d\u044b\u043c \u043f\u0440\u0430\u043a\u0442\u0438\u0447\u0435\u0441\u043a\u0438\u043c \u0432\u044b\u0432\u043e\u0434\u043e\u043c \u043f\u043e \u0442\u0435\u043c\u0435 "${correct.topic}"?`,
        `\u041a\u0430\u043a\u043e\u0435 \u0443\u0442\u0432\u0435\u0440\u0436\u0434\u0435\u043d\u0438\u0435 \u043e\u0442\u0440\u0430\u0436\u0430\u0435\u0442 \u043c\u0430\u0442\u0435\u0440\u0438\u0430\u043b \u0440\u0430\u0437\u0434\u0435\u043b\u0430 "${correct.topic}"?`
      ]
    : [
        `Choose the statement that accurately matches "${correct.topic}".`,
        `Which option is supported by the content of "${correct.topic}"?`,
        `What is a correct practical takeaway from "${correct.topic}"?`,
        `Which statement reflects the material in "${correct.topic}"?`
      ];
