...
export function normalizeGenerationSettings(value) {
  ...
  return {
    ...
    maxTokens: Math.max(1000, Math.min(200000, Math.trunc(Number(source.maxTokens) || defaults.maxTokens || 64000)))
  };
}
...
export function normalizeGenerateInput(payload) {
  ...
  return {
    ...
    structure,
    finalTest,
    generation: normalizeGenerationSettings(payload?.generation)
  };
}
